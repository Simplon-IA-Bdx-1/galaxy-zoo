...
# Transform the skewed numeric features by taking log(feature + 1) - features looks more normal.
...
# Regularized linear regression models from the scikit learn module
